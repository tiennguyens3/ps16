...
class Waave_Pg extends PaymentModule
{
    ...
    private function _postValidation()
    {
        if (Tools::isSubmit('btnSubmit')) {
            if (!Tools::getValue('ACCESS_KEY')) {
                $this->_postErrors[] = $this->l('"Access Key" field is required.', [], 'Modules.Checkpayment.Admin');
            }
            if (!Tools::getValue('PRIVATE_KEY')) {
                $this->_postErrors[] = $this->l('The "Private Key" field is required.', [], 'Modules.Checkpayment.Admin');
            }
            if (!Tools::getValue('VENUE_ID')) {
                $this->_postErrors[] = $this->l('The "Venue Id" field is required.', [], 'Modules.Checkpayment.Admin');
            }
        }
    }
    ...
    private function _postProcess()
    {
        ...
        $this->_html .= $this->displayConfirmation($this->l('Settings updated', [], 'Admin.Notifications.Success'));
    }
}
